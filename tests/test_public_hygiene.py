...
class PublicHygieneTests(unittest.TestCase):
    ...
    def test_distribution_validator_requires_v110_release_delivery_gate(self):
        validator = (ROOT / "scripts" / "validate.py").read_text(encoding="utf-8")
        for phrase in (
            "validate_release_delivery.py",
            "v1.1-release-contract.json",
    ...
    def test_bilingual_docs_describe_published_v09_and_v110_nonhardware_verification(self):
    ...
    def test_v050_completion_audit_records_live_evidence_and_hardware_boundary(self):
        ...
        self.assertIn("# v0.5 Completion Audit", audit)
        for phrase in (
            "31755294605",
            "31755295908",
    ...
    def test_v060_audit_preserves_no_purchase_and_no_motion_boundary(self):
        audit = (ROOT / "docs/releases/v0.6-completion-audit.md").read_text(
            encoding="utf-8"
        )
        self.assertIn("procurement_authorized: false", audit)
