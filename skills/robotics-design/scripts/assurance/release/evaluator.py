...
V110_RUNTIME_PATHS = frozenset(
    {
        ...
        "reference/mobile-manipulator/simulation/calibration-synthetic.json",
        "reference/mobile-manipulator/simulation/Dockerfile.jazzy-harmonic",
        "reference/mobile-manipulator/simulation/ros-workspace-manifest.json",
        ...
        "skills/robotics-design/scripts/assurance/artifacts.py",
        ...
        "skills/robotics-design/scripts/assurance/model.py",
        "skills/robotics-design/scripts/assurance/plugin_contracts.py",
        "skills/robotics-design/scripts/assurance/units.py",
